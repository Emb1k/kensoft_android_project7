...
public class MainActivity extends AppCompatActivity {
    ...
    String url = "https://api.github.com/repos/cryptomator/cryptomator/issues"; // Адрес получения JSON - данных
        ...
        if (json != null) {
            try {
                ...
                for (int i = 0; i < array.length(); i ++){
                    ...
                    JSONObject user = array1.getJSONObject("user");
                    String name = array1.getString("id");
                    ...
                    textView.append("Name: " + login + "\n");
                    textView.append("Created at: " + date2 + "\n");
                    textView.append("Updated at: " + date3 + "\n\n");
                  }
